package com.diazmartin.springboot.backend.clientesapirest.contreollers;
...
import com.diazmartin.springboot.backend.clientesapirest.models.services.IClienteService;
...
public class ClienteRestController {
	...
	public ResponseEntity<?> detele(@PathVariable Long id) {
		...
		response.put("mensaje", "El cliente fue eliminadop correctamente");
